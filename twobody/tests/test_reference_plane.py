...
def test_sanity():
    rep1 = coord.CartesianRepresentation(x=[0, 1.0], y=0, z=0, unit=u.pc)

    rep2 = coord.CartesianRepresentation(x=0, y=[0, 1.0], z=0, unit=u.pc)

    rep3 = coord.CartesianRepresentation(x=0, y=0, z=[0, 1.0], unit=u.pc)
